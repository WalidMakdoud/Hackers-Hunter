#!/usr/bin/python
#script by : https://github.com/WalidMakdoud
...
print colors.ORANGE+"[*] Written by: WALID MAKDOUD - Instagram: instagram.com/xx_xwalidxx [*]\n"+colors.END		
...
#Instagram   
     ...
     if response.status_code == 200:
         response.close()
         print  "[\033[36m+\033[0m]\033[36m Instagram :\033[0m \033[0;37m" + url + "\033[0m"
     else:print "[\033[31m-\033[0m]\033[36m Instagram :\033[0m \033[33mNot Found !\033[0m"
#H1   
